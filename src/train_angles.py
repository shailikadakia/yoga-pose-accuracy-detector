...
IN_PATH = "../pose_angles_dataset.csv"      # <-- angles/cues dataset (not raw xyz)
OUT_BUNDLE = "pose_knn_runtime.pkl"         # clean runtime bundle (no custom funcs)
...
# keep a note of feature names for debugging/inference sanity
